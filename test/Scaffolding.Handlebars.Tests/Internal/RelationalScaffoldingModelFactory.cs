...
namespace Scaffolding.Handlebars.Tests.Internal
{
    ...
    public class RelationalScaffoldingModelFactory : IScaffoldingModelFactory
    {
        ...
        protected virtual string GetEntityTypeName(DatabaseTable table)
        {
            ...
            return _tableNamer.GetName(table);
        }
        ...
        {
            if (table == null) throw new ArgumentNullException(nameof(table));
            return _dbSetNamer.GetName(table);
        }
        ...
        {
            if (builder == null) throw new ArgumentNullException(nameof(builder));
            if (uniqueConstraints == null) throw new ArgumentNullException(nameof(uniqueConstraints));
        ...
        {
            if (builder == null) throw new ArgumentNullException(nameof(builder));
            if (uniqueConstraint == null) throw new ArgumentNullException(nameof(uniqueConstraint));
        ...
        {
            if (databaseForeignKey == null) throw new ArgumentNullException(nameof(databaseForeignKey));
            if (foreignKey == null) throw new ArgumentNullException(nameof(foreignKey));
        ...
        private string NavigationUniquifier(string proposedIdentifier, ICollection<string> existingIdentifiers)
        {
